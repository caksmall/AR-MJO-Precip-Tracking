...
ncout = Dataset('/home/disk/orca/csmall3/AR_testing_research/Final_AR_Results/nc_files/MJO_LPT_NC/RMM_Phase/MJO_Active/DJFM_MJO_Act_LPT_Hours_RMM_7_pt_'+str(instance)+'.nc','w','NETCDF4'); # using netCDF3 for output format 
