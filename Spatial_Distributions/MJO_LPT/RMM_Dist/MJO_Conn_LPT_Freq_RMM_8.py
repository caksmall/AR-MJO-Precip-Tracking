...
ncout = Dataset('/home/disk/orca/csmall3/AR_testing_research/Final_AR_Results/nc_files/MJO_LPT_NC/RMM_Phase/MJO_Connected/DJFM_MJO_Conn_LPT_Hours_RMM_8_pt_'+str(instance)+'.nc','w','NETCDF4'); # using netCDF3 for output format 
