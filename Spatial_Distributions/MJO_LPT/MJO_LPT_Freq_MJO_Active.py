...
## This script by Chad Small calculates density of MJO LPT masks by LPT hours for MJO Active ARs in DJFM 

instance = int(sys.argv[1])
bef_ints = instance - 1

#bring in MJO-Connected ARs
mjo_og = pd.read_csv('/home/disk/orca/csmall3/AR_testing_research/Final_AR_Results/text_files/ERM_3day_MJO_Active_ARs.csv')
...
ncout = Dataset('/home/disk/orca/csmall3/AR_testing_research/Final_AR_Results/nc_files/MJO_LPT_NC/DJFM_MJO_Act_LPT_Hours_pt_'+str(instance)+'.nc','w','NETCDF4'); # using netCDF3 for output format 
