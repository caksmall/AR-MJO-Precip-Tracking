...
## This script by Chad Small calculates density of MJO LPT masks by LPT hours for MJO Connected ARs in DJFM 
...
ncout = Dataset('/home/disk/orca/csmall3/AR_testing_research/Final_AR_Results/nc_files/MJO_LPT_NC/DJFM_MJO_Conn_LPT_Hours_pt_'+str(instance)+'.nc','w','NETCDF4'); # using netCDF3 for output format 
