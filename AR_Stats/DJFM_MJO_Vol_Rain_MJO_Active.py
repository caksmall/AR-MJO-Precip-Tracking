...
## This script by Chad Small extracts all MJO LPT volumetric rainfall values of every MJO LPT instance that is associated with MJO-Active ARs (DJFM)
...
#save the ERM Data
mjo_vol_df.to_csv('/home/disk/orca/csmall3/AR_testing_research/Final_AR_Results/text_files/DJFM_MJO_LPT_Vol_Rain_MJO_Active.csv') 
