...
pac_ars_df = pd.read_csv('/home/disk/orca/csmall3/AR_testing_research/Final_AR_Results/text_files/Pac_Basin_MJO_Connected_ARs.csv')
...
for jj in range(0,len(pac_ars_df)):
    ...
    for j in range(0, len(ar_test['time'])):
        ...
        if bool_match == True:
            ...
            # fig.show()
            plt.savefig('/home/disk/orca/csmall3/AR_testing_research/Final_AR_Results/Figures/LF_MJO_Conn_Match/'+lpt_id_tit+'_'+year_str+'.png')
...
AR_MJO_overlp_df.to_csv('/home/disk/orca/csmall3/AR_testing_research/Final_AR_Results/text_files/LF_MJO_Connected_ARs.csv') 